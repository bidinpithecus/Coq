...
From MYCOQ Require Export Poly.
...
Theorem silly2 : forall (n m o p : nat),
	...
	[n;o] = [m;p].
Proof.
	intros n m o p eq1 eq2. apply eq2.
	apply eq1.
Qed.
...
Example trans_eq_example'' : forall (a b c d e f : nat),
		 ...
		 [a;b] = [e;f].
Proof.
	intros a b c d e f eq1 eq2. transitivity [c;d].
	apply eq1. apply eq2.
Qed.
...
Proof.
	...
	injection H as H1 H2. transitivity z.
	apply H1. symmetry.
	apply H2.
Qed.
